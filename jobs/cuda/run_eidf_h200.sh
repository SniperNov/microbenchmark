#!/bin/bash
# EIDF H200 CUDA run script for VDI sessions.
...
echo "Running EIDF H200 CUDA benchmark groups..." | tee "$OUTFILE"
...
echo "" | tee -a "$OUTFILE"
echo "All EIDF H200 CUDA benchmark groups completed." | tee -a "$OUTFILE"
