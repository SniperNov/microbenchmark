...
echo "Running EIDF A100 OpenMP benchmark groups..." | tee "$OUTFILE"
...
echo "========== EIDF A100 configuration ==========" | tee -a "$OUTFILE"
...
echo "" | tee -a "$OUTFILE"
echo "All EIDF A100 benchmark groups completed." | tee -a "$OUTFILE"
