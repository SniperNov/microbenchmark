...
echo "Running EIDF H100 NVHPC OpenMP benchmark groups..." | tee "$OUTFILE"
...
echo "SET UP H100 configuration NVIDIA H100 NVHPC=====" | tee -a "$OUTFILE"
...
echo "" | tee -a "$OUTFILE"
echo "All EIDF H100 NVHPC benchmark groups completed." | tee -a "$OUTFILE"
